...
export default LiveLocationModal = ({ modalVisible, setModalVisible, tripFromLoc, TripToLoc }) => {
    ...
    const [startCoords, setStartCoords] = useState([12.534744, 50.373783])
    const [ceneterdcoords, setCenteredCoords] = useState([12.534744, 50.373783])
    ...
    async function createRouterLine(params) {
        const startCoords = `${tripFromLoc[0]},${tripFromLoc[1]}`
        console.log('my location ->', startCoords);
        const endCoords = `${TripToLoc[0]},${TripToLoc[1]}`
        setStartCoords(tripFromLoc)
        setDestinationCoords(TripToLoc)
        ...
        <Modal
            ...
            <View style={styles.container}>
                ...
                <MapboxGL.MapView
                    ...
                    <MapboxGL.Camera
                        zoomLevel={13}
                        centerCoordinate={ceneterdcoords}
                        animationMode={'flyTo'}
                    ...
                    >
                        <View style={styles.destinationIcon}>
                            <MaterialIcons name={'person-pin-circle'} color={"blue"} size={40} />
                        </View>
                    </MapboxGL.PointAnnotation>
                    <MapboxGL.PointAnnotation
                        id='destinationRoute'
