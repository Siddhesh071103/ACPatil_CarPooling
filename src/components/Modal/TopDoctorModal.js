...
const data = [
    ...
    },
    {
        ...
        lottieAssets: require('../../assets/json/ecolottie/bikeani2.json')
    },
    {
        Rides: 'Ride to Virar',
        vehicle: 'Car',
        location: 'Virar,Palghar',
        lottieAssets: require('../../assets/json/ecolottie/caranim3.json')
    },
    {
        Rides: 'Ride to ChurchGate',
        vehicle: 'Bike',
        location: 'ChurchGate,Mumbai',
        lottieAssets: require('../../assets/json/ecolottie/bikeanim3.json')
    },
    {
        Rides: 'Ride to GhatKoper',
        vehicle: 'Car',
        ...
        <Modal
            ...
            <View style={styles.container}>
                ...
                <View style={styles.header}>
                    <Header leftIconName header={'Top Rides'} rightIconName={'search'} isModal setModalVisible={setModalVisible} />
