...
export default function Template({  }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.subContainer}>
                <LottieView source={require("../../assets/json/ecolottie/first page animation.json")} autoPlay loop style={{ width: 360, height: 350, }} />
            </View>
            <View style={styles.subContainer}>

                <View style={{ alignItems: "center", margin: 10 }}>
                    <Text style={styles.bigText}>We Take Care Of Your Trip</Text>
                    <Text style={styles.smallText}>Through care and expertise,EchoLane shapes destinies, fostering wellness and resilience for humanity's journey.</Text>
                </View>
            </View>
            <View style={styles.subContainer}>
                <TouchableOpacity
