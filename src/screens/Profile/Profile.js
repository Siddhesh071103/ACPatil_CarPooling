    ...
    <View style={styles.container}>
      <ScrollView style={styles.subContainer}>
        ...
        <TouchableOpacity
          onPress={() => { SendSOS() }}
          style={{ flexDirection: "row", padding: 10 }}>
          <MaterialIcons name={'sos'} color={colorTheme.primaryColor} size={24} />
          <View style={{ flexDirection: "row", justifyContent: 'space-between', alignItems: "center", width: '92%', paddingHorizontal: 10 }}>
